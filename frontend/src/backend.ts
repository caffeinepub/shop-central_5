...
import type { Category as _Category, DeliveryType as _DeliveryType, Order as _Order, OrderItem as _OrderItem, OrderStatus as _OrderStatus, Product as _Product, ProductId as _ProductId, UserOrderHistory as _UserOrderHistory, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProduct(arg0: string, arg1: string, arg2: bigint, arg3: Category, arg4: string, arg5: bigint, arg6: DeliveryType): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.createProduct(arg0, arg1, arg2, to_candid_Category_n10(this._uploadFile, this._downloadFile, arg3), arg4, arg5, to_candid_DeliveryType_n12(this._uploadFile, this._downloadFile, arg6));
    ...
    async getOrderHistory(): Promise<UserOrderHistory> {
        if (this.processError) {
            try {
                const result = await this.actor.getOrderHistory();
                return from_candid_UserOrderHistory_n24(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateProduct(arg0: ProductId, arg1: string, arg2: string, arg3: bigint, arg4: Category, arg5: string, arg6: bigint, arg7: DeliveryType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, arg1, arg2, arg3, to_candid_Category_n10(this._uploadFile, this._downloadFile, arg4), arg5, arg6, to_candid_DeliveryType_n12(this._uploadFile, this._downloadFile, arg7));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_DeliveryType_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DeliveryType): DeliveryType {
...
function from_candid_UserOrderHistory_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _UserOrderHistory): UserOrderHistory {
...
function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        deliveryType: from_candid_DeliveryType_n16(_uploadFile, _downloadFile, value.deliveryType),
...
function from_candid_record_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        orders: from_candid_vec_n26(_uploadFile, _downloadFile, value.orders)
    };
}
...
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    oneHourDelivery: null;
} | {
    takeaway: null;
}): DeliveryType {
    return "oneHourDelivery" in value ? DeliveryType.oneHourDelivery : "takeaway" in value ? DeliveryType.takeaway : value;
}
function from_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "clothing" in value ? Category.clothing : "food" in value ? Category.food : "books" in value ? Category.books : "electronics" in value ? Category.electronics : value;
}
...
function to_candid_DeliveryType_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: DeliveryType): _DeliveryType {
...
function to_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: DeliveryType): {
    oneHourDelivery: null;
} | {
    takeaway: null;
} {
    return value == DeliveryType.oneHourDelivery ? {
        oneHourDelivery: null
    } : value == DeliveryType.takeaway ? {
        takeaway: null
    } : value;
}
